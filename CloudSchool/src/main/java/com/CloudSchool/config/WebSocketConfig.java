...
import com.CloudSchool.Interceptor.MyWebSocketInterceptor;
...
public class WebSocketConfig extends WebSocketConfigurationSupport {
	...
	protected void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		...
		registry.addHandler(new MyWebSocketHandler(), "/mywebsocket").setAllowedOrigins("*").addInterceptors(new MyWebSocketInterceptor());
	}
}
